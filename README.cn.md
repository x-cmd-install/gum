...
[![x-cmd/install — gum Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gum.svg?lang=zh)](https://x-cmd.com/install/gum)
...
合计: **4,878** 行代码（覆盖前 5 种语言、共 **75** 个文件）。
...
- **上游仓库**: <https://github.com/charmbracelet/gum>
- **许可证**: MIT

## 发布

- **最新版本**: `v2.0.1` (2026-09-11)
- **最近提交**: 2026-09-11
- **Release 含资产**: 67 个

## 流行度

- **Star**: 24,409 · **Fork**: 551 · **开放 issue**: 481 · **贡献者**: 77

## 累计统计

- **发布数**: 28 · **已合并 PR**: 397 · **开放 PR**: 66 · **已关闭 issue**: 339 · **开放 issue**: 142 · **提交数**: 682
...
gum 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `gum` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gum.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T06:04:17Z._
